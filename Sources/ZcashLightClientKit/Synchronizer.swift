...
/// ``GetTreeStateUnimplemented``/``BroadcasterUnimplemented`` do): the migration group has many
/// throwing requirements, and duplicating that two-struct precedent once per member would be pure
