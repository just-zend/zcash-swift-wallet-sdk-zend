...
///    (`migrationReconcileInvalidations`) would otherwise treat the not-yet-visible broadcast as a
///    submit crash. This is the `inFlightUntil` timestamp persisted here; a crash between submit
