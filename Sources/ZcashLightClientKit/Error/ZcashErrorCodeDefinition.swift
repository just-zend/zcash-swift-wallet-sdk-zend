...
enum ZcashErrorDefinition {
    ...
    // ZRUST0093-ZRUST0097 retired pre-release with the alternative sync engine they served, and
    // with it the whole engine-handle lifecycle they reported on (open, not-open, start,
    // sync-failed, unsupported-operation). Do not reuse the codes.
