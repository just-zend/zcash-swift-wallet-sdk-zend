...
public enum ZcashError: Equatable, Error {
    ...
    /// - `rustError` contains error generated by the rust layer.
    /// ZRUST0107
    case rustMigrationExtractBroadcastTx(_ rustError: String)
    ...
    /// ZCBPEO0024
    case compactBlockProcessorServerTipBehind(_ localFloor: BlockHeight, _ highestObserved: BlockHeight, _ attempts: Int)
    ...
    public var message: String {
        ...
        case .rustMigrationState: return "Error from rust layer when calling ZcashRustBackend.migrationState"
        ...
        case .rustMigrationSignAndStore: return "Error from rust layer when calling ZcashRustBackend.migrationSignAndStore"
        case .rustMigrationIsSyncRequired: return "Error from rust layer when calling ZcashRustBackend.migrationIsSyncRequired"
        case .rustMigrationNextDueTransfer: return "Error from rust layer when calling ZcashRustBackend.migrationNextDueTransfer"
        ...
        case .rustMigrationInitializePostUpgrade: return "Error from rust layer when calling ZcashRustBackend.migrationInitializePostUpgrade"
        case .rustMigrationExtractBroadcastTx: return "Error from rust layer when calling ZcashRustBackend.migrationExtractBroadcastTx"
        ...
        case .migrationOrdinarySpendsBlocked: return "Ordinary wallet spending is blocked by the active Ironwood migration."
        case .rustMigrationSnapshot: return "Error from rust layer when reading the authoritative migration snapshot."
        case .rustMigrationProposePrivateIntents: return "Error from rust layer when proposing a private anchorless intent schedule."
        case .rustMigrationProposeImmediateIntent: return "Error from rust layer when proposing an immediate anchorless intent."
        case .rustMigrationCommitIntents: return "Error from rust layer when committing an approved intent schedule."
        case .rustMigrationClaimNextDueTransfer: return "Error from rust layer when claiming a persisted due migration transaction."
        case .rustMigrationMaterializeAndClaimNextDue: return "Error from rust layer when materializing and claiming a software-signed intent."
        case .rustMigrationStageNextDueExternalPCZT: return "Error from rust layer when staging a due intent for an external signer."
        case .rustMigrationResumeStagedSubmission: return "Error from rust layer when resuming an engine-owned signed submission."
        case .rustMigrationStoreSignedDueIntent: return "Error from rust layer when storing a device-signed due intent."
        case .rustMigrationRecordClaimedTransferResult: return "Error from rust layer when recording a tokenized migration submission result."
        case .rustMigrationClaimNoteSplitSubmission: return "Error from rust layer when ingesting and claiming a persisted denomination-split transaction."
        ...
        case .compactBlockProcessorServerTipBehind: return "Every sampled server tip was below durable local wallet state. Retrying may select a healthy load-balanced replica."
    ...
    public var code: ZcashErrorCode {
        ...
        case .rustMigrationState: return .rustMigrationState
        ...
        case .rustMigrationSignAndStore: return .rustMigrationSignAndStore
        case .rustMigrationIsSyncRequired: return .rustMigrationIsSyncRequired
        case .rustMigrationNextDueTransfer: return .rustMigrationNextDueTransfer
        ...
        case .rustMigrationInitializePostUpgrade: return .rustMigrationInitializePostUpgrade
        case .rustMigrationExtractBroadcastTx: return .rustMigrationExtractBroadcastTx
        ...
        case .migrationOrdinarySpendsBlocked: return .migrationOrdinarySpendsBlocked
        case .rustMigrationSnapshot: return .rustMigrationSnapshot
        case .rustMigrationProposePrivateIntents: return .rustMigrationProposePrivateIntents
        case .rustMigrationProposeImmediateIntent: return .rustMigrationProposeImmediateIntent
        case .rustMigrationCommitIntents: return .rustMigrationCommitIntents
        case .rustMigrationClaimNextDueTransfer: return .rustMigrationClaimNextDueTransfer
        case .rustMigrationMaterializeAndClaimNextDue: return .rustMigrationMaterializeAndClaimNextDue
        case .rustMigrationStageNextDueExternalPCZT: return .rustMigrationStageNextDueExternalPCZT
        case .rustMigrationResumeStagedSubmission: return .rustMigrationResumeStagedSubmission
        case .rustMigrationStoreSignedDueIntent: return .rustMigrationStoreSignedDueIntent
        case .rustMigrationRecordClaimedTransferResult: return .rustMigrationRecordClaimedTransferResult
        case .rustMigrationClaimNoteSplitSubmission: return .rustMigrationClaimNoteSplitSubmission
        ...
        case .compactBlockProcessorServerTipBehind: return .compactBlockProcessorServerTipBehind
