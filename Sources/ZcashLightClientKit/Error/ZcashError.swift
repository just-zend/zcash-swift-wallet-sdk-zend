...
public enum ZcashError: Equatable, Error {
    ...
    /// - `rustError` contains error generated by the rust layer.
    /// ZRUST0107
    case rustMigrationProposeImmediateTransfers(_ rustError: String)
    ...
    public var message: String {
        ...
        case .rustMigrationProposeImmediateTransfers: return "Error from rust layer when calling ZcashRustBackend.migrationProposeImmediateTransfers"
    ...
    public var code: ZcashErrorCode {
        ...
        case .rustMigrationProposeImmediateTransfers: return .rustMigrationProposeImmediateTransfers
