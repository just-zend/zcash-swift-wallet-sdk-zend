...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/zcash/zcash-swift-wallet-sdk/releases/download/2.7.0/libzcashlc.xcframework.zip",
            checksum: "be42e8e1666343d8fdb1424deaa4f957a3ea59363338c8e9a14bd64c92591583"
        )
    )
